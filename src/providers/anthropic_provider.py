...
class AnthropicProvider(BaseProvider):
    ...
    def _validate_config(self) -> None:
        ...
        self.llm_model = self.config.get("llm_model", "claude-3-5-haiku-20241022")
    ...
    async def create_embeddings(
        ...
        return EmbeddingResponse(embeddings=embeddings, model="anthropic-fallback")
                    ...
                    if response.status == 200:
                        ...
                        if content_blocks:
                            ...
                            return CompletionResponse(
                                content=content, usage=usage, model=completion_model
                            )
                        else:

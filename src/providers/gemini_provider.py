...
class GeminiProvider(BaseProvider):
    ...
    def _validate_config(self) -> None:
        ...
        self.embedding_model = self.config.get("embedding_model", "text-embedding-004")
                ...
                try:
                    ...
                    async with session.post(
                        ...
                        if response.status == 200:
                            ...
                            embedding = result.get("embedding", {}).get(
                ...
                async with session.post(
                    ...
                    if response.status == 200:
                        ...
                        if candidates:
                            ...
                            return CompletionResponse(content=content, model=completion_model)
                        else:
